...
from utils.initial_distribution import (
    compute_majority_counts as shared_compute_majority_counts,
)
from utils.utils import generate_initial_distribution_shared
...
def get_rules_json_path(csv_path: str) -> str:
    ...
    output_dir = os.getenv('AUTOMATON_RULES_ROOT', os.path.join(SCRIPT_DIR, "extracted_rules"))
...
def run_simulations_from_csv(
    ...
    output_parts = [
        os.getenv('AUTOMATON_OUTPUT_ROOT', os.path.join(SCRIPT_DIR, "resultados")),
        model_slug,
        token_slug,
        window_slug,
        prompt_strategy,
