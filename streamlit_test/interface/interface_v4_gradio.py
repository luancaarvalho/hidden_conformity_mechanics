        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                selected_server = gr.Dropdown(
                    ...
                    value="⚡ vLLM (A100 - 8000)",
                )
                base_url = gr.Textbox(label="Base URL (opcional)", value=SERVER_PRESETS["⚡ vLLM (A100 - 8000)"], interactive=False)
                base_url_hint = gr.Markdown(SERVER_PRESETS["⚡ vLLM (A100 - 8000)"])
...
# ==============================================================================
# Run:
#   python projeto_final/streamlit_test/interface/interface_v4_gradio.py
# Optional:
